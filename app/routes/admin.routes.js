...
var   drugsInputDir                    = process.cwd() + "/../input/all/dm_spl_monthly_update_jan2016/homeopathic";

drugsInputDir = "/home/zoliqa/Documents/drugsdb/input/selected/";
...
router.post("/import", passportUtilities.isAdminUser, function (req, res, next) {
	var processFiles = require("../data.import/process.files");
